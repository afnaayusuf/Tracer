...
| E-ING-06 | Timezone and DST | "Yesterday afternoon" across a DST switch or a site in another timezone. | All storage in UTC ms; site timezone stored in KB; agent resolves local windows explicitly and echoes them in the answer. | implemented | test_schemas.py::test_timestamps_are_utc_ms_only<br>test_store_agent.py::test_every_millisecond_column_is_64_bit_on_postgres |
